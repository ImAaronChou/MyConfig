# Generated by Powerlevel10k configuration wizard on 2021-03-08 at 11:55 CST.
...
# 24h time, 2 lines, solid, left frame, white-ornaments, compact, many icons, concise,
...
() {
  ...
  # Bold directory.如果要加粗整个目录，则需要把POWERLEVEL9K_DIR_ANCHOR_FOREGROUND和POWERLEVEL9K_DIR_SHORTENED_FOREGROUND注释掉
  ...
  function my_git_formatter() {
    ...
    #自定义git的显式格式
    typeset -g my_git_format=${1+%B%4F}git:($res${1+%4F})
  }
